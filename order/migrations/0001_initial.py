    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_mode', models.CharField(choices=[('Cod', 'Cod'), ('Card', 'Card')], default='Card', max_length=50)),
                ('status', models.CharField(choices=[('Processing', 'Processsing'), ('Shipped', 'Shipped'), ('Delivered', 'Delivered')], default='Processing', max_length=50)),
